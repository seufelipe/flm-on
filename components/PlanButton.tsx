  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="flex sm:max-w-md overflow-hidden" aria-describedby={undefined}>
        {/* PlanPanel draws its own visible "Your plan" heading, but only when it has a header to
            draw; Radix requires a title on every dialog, so this is the accessible one. */}
